...
// האדמין משתמש באותו מפתח שהוגדר אצלך ב-RESEND_API_KEY
...
'[dadadelivery2017@gmail.com](mailto:dadadelivery2017@gmail.com)';
...
const customerSection = ` <div style="
   background:#f8fafc;
   padding:15px;
   border-radius:10px;
   margin:15px 0;
...
try {
  ...
  if (
    ...
    // ההזמנה עדיין נשמרת גם אם המייל נכשל
  }
